...
public class ConfiguredInternalTopicTest {
    ...
    public void testToString() {
        ...
        ConfiguredInternalTopic config = new ConfiguredInternalTopic("test-topic", topicConfigs, Optional.of(3), Optional.of((short) 2));
        String expectedString = "ConfiguredInternalTopic(name=test-topic, topicConfigs={retention.ms=1000}, numberOfPartitions=Optional[3], "
    ...
    public void testAsStreamsGroupDescribeTopicInfo() {
        ...
        Map<String, String> topicConfigs = new HashMap<>();
        topicConfigs.put("retention.ms", "1000");
        Optional<Integer> numberOfPartitions = Optional.of(3);
        ...
        assertEquals(numberOfPartitions.orElse(0).intValue(), topicInfo.partitions());
