...
def create_verifiable_client_implementation(context, parent):
    ...
    in context.globals as "Verifiable<type>" where <type> is "Producer" or "Consumer" or "ShareGroup",
...
class VerifiableClientJava (VerifiableClient):
    """
    Verifiable Consumer, ShareGroup and Producer using the official Java client.
    """
    def __init__(self, parent, conf=None):
        """
        :param parent: The parent instance, either VerifiableConsumer, VerifiableShareGroup or VerifiableProducer
